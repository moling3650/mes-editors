export default {
  ...
  cols: [
    ...
    {field: 'startHour', title: '开始时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true},
    {field: 'endHour', title: '结束时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true},
  ...
  getForm (form = null, type = 'add', opts) {
    return Promise.resolve({
      ...
      // 表单元素
      formItems: [
        {value: 'startHour', label: '开始时间', span: 12, component: 'el-input',},
        {value: 'endHour', label: '结束时间', span: 12, component: 'el-input'},

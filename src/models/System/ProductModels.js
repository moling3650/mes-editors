...
export default {
  ...
  // 表格列配置
  cols: [
    {field: 'modelCode', title: '型号编号', width: 250, titleAlign: 'center', columnAlign: 'center', isResize: true, isEdit: true},
    {field: 'modelName', title: '型号名称', width: 250, titleAlign: 'center', columnAlign: 'center', isResize: true},

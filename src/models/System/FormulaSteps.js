...
export default {
  ...
  cols: [
    ...
    {field: 'typeId', title: '驱动类型', width: 150, titleAlign: 'left', columnAlign: 'left', isResize: true, formatter: true},
    {field: 'driveCode', title: '驱动名称', width: 150, titleAlign: 'left', columnAlign: 'left', isResize: true, formatter: true},
    ...
    {field: 'matCode', title: '物料编号', width: 150, titleAlign: 'left', columnAlign: 'left', isResize: true, formatter: true},
  ...
  getForm (form = null, type = 'add', opts) {
    return Promise.resolve({
      ...
      formItems: [
        ...
        {value: 'driveCode', label: '驱动名称', span: 12, component: 'ex-select', options: opts.driveCode},
        ...
        {value: 'matCode', label: '物料编号', span: 12, component: 'ex-select', options: opts.matCode},

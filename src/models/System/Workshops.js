...
export default {
  ...
  // 表格列配置
  cols: [
    {field: 'wsCode', title: '车间编号', width: 250, titleAlign: 'center', columnAlign: 'center', isResize: true, isEdit: true},
    {field: 'wsName', title: '车间名称', width: 250, titleAlign: 'center', columnAlign: 'center', isResize: true},

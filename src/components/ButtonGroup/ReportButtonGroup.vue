<template>
  <div id="ReportButtonGroup">
    <div class="select-wrap">
      <ex-select :options="reportOptions" :value="reportCode" clearable placeholder="请选择报表" @change="handleReportChange"/>
    </div>
...
export default {
  ...
  methods: {
    handleReportChange (reportCode) {
      this.$emit('update:reportCode', reportCode)
    },

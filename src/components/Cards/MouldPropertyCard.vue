<template>
  <el-card class="h600">
    <div slot="header" class="clearfix">
      ...
      <el-button @click="editMouldProperty(selectMouldProperty)" :disabled="propertyDisabled" type="primary" icon="el-icon-edit" size="mini"></el-button>
      <el-button @click="deleteMouldProperty(selectMouldProperty)" :disabled="propertyDisabled" type="danger" icon="el-icon-delete" size="mini"></el-button>
      <el-button icon="el-icon-plus" class="fl-r p3-0" type="text" @click="addMouldProperty">添加类别属性</el-button>
    </div>
